...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">P02</span> - Perkin Elmer Detector</p><p><br/><span style=\" font-weight:600;\">ID15</span> - Mar555 detector. </p><p>Works if CrysAlis files are in <span style=\" font-weight:600;\">.esperanto</span> format and Dioptas mask was created based on <span style=\" font-weight:600;\">.mar2560</span> file. Tested with Dioptas 0.5.0. <span style=\" color:#ff0000;\">Might be not pixel precise. Try to grow mask a bit</span></p><p><br/><span style=\" font-weight:600;\">13 IDD</span> - not working yet</p></body></html>"))
